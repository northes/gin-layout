...
func (uu *UserUpdate) SetPhone(i int64) *UserUpdate {
...
func (uu *UserUpdate) AddPhone(i int64) *UserUpdate {
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.Phone(); ok {
		_spec.SetField(user.FieldPhone, field.TypeInt64, value)
	}
	if value, ok := uu.mutation.AddedPhone(); ok {
		_spec.AddField(user.FieldPhone, field.TypeInt64, value)
	}
...
// SetPhone sets the "phone" field.
func (uuo *UserUpdateOne) SetPhone(i int64) *UserUpdateOne {
...
// AddPhone adds i to the "phone" field.
func (uuo *UserUpdateOne) AddPhone(i int64) *UserUpdateOne {
