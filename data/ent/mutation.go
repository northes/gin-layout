...
func (m *UserMutation) SetPhone(i int64) {
	m.phone = &i
	m.addphone = nil
}

// Phone returns the value of the "phone" field in the mutation.
func (m *UserMutation) Phone() (r int64, exists bool) {
	v := m.phone
	if v == nil {
		return
	}
...
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldPhone(ctx context.Context) (v int64, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *UserMutation) AddPhone(i int64) {
	if m.addphone != nil {
		*m.addphone += i
	} else {
		m.addphone = &i
...
func (m *UserMutation) AddedPhone() (r int64, exists bool) {
	v := m.addphone
	if v == nil {
		return
	}
